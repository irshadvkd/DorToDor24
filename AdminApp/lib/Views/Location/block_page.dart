...
import 'package:dortodorpartner/Views/Location/block_add_page.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BlockPage extends GetView<LocationController> {
      ...
      builder: (controller) {
        return CommonAppBar(
          ...
          child: RefreshIndicator(
            onRefresh: () async =>
                controller.getBlock(context, governorateId, cityId),
            child: controller.blockLoader
                ? Column(
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          itemCount: controller.block.length,
                          shrinkWrap: true,
  ...
  Widget blockCard(context, currentIndex) {
            ...
            CommonAlertConfirm(
              ...
              onTap: () {
                controller.deleteBlock(
                    context, governorateId, cityId, currentIndex['id']);
              },
            ),
          );
        }
